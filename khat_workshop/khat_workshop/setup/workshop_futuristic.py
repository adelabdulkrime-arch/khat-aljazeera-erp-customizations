...
# ── Shared desk-navbar layer ────────────────────────────────────────────────
# Language switcher, logout item and sidebar-header hiding. This block was
# duplicated byte-for-byte in all SEVEN dashboard builders; it targets the desk
# navbar (outside the Custom HTML Block shadow root) via document.querySelector,
# so one definition imported everywhere behaves identically.
NAV_LANG_JS = r"""
(function(){
