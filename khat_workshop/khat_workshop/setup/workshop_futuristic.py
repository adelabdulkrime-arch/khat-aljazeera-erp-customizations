...
COMMANDS = [
    ...
    {"label": "عروض الأسعار", "label_en": "Quotations", "action": "list", "target": "Quotation", "icon": "file", "source": "الورشة", "source_en": "Workshop"},
    {"label": "فواتير الإصلاح", "label_en": "Repair Invoices", "action": "list", "target": "Sales Invoice", "icon": "receipt", "source": "الورشة", "source_en": "Workshop"},
    {"label": "الدفعات", "label_en": "Payments", "action": "list", "target": "Payment Entry", "icon": "credit-card", "source": "الورشة", "source_en": "Workshop"},
    {"label": "الباقات", "label_en": "Packages", "action": "list", "target": "Product Bundle", "icon": "gift", "source": "الورشة", "source_en": "Workshop"},
...
# desk.js's #kaj-lang-style (public/js/desk.js), inside FUTURISTIC_JS_TEMPLATE below.
CMDK_HEAD_CSS = """
